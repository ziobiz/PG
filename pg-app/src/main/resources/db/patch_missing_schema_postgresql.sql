...
-- V178: URL 분할구매 — db/V178_split_pay.sql 과 동일
...
CREATE TABLE IF NOT EXISTS tb_split_pay_contract (
    ...
    customer_email VARCHAR(255) NOT NULL, customer_name VARCHAR(200), total_amount NUMERIC(20, 4) NOT NULL,
    currency_code VARCHAR(10) NOT NULL DEFAULT 'JPY', installment_count INTEGER NOT NULL, interval_type VARCHAR(16) NOT NULL,
    interval_value INTEGER NOT NULL DEFAULT 1, status VARCHAR(16) NOT NULL DEFAULT 'ACTIVE', first_pay_mode VARCHAR(16) NOT NULL DEFAULT 'IMMEDIATE',
    snap_split_pay_fee_pct NUMERIC(5, 2) NOT NULL DEFAULT 0, snap_split_fixed_per_inst NUMERIC(12, 1) NOT NULL DEFAULT 0,
    snap_split_fixed_total NUMERIC(12, 1) NOT NULL DEFAULT 0, contract_date DATE NOT NULL, channel VARCHAR(32) NOT NULL DEFAULT 'URL',
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    cancelled_at TIMESTAMP, CONSTRAINT uq_split_pay_contract_no UNIQUE (contract_no));
CREATE TABLE IF NOT EXISTS tb_split_pay_installment (
    id BIGSERIAL PRIMARY KEY, contract_id BIGINT NOT NULL REFERENCES tb_split_pay_contract(id) ON DELETE CASCADE,
    installment_no INTEGER NOT NULL, order_no VARCHAR(64) NOT NULL, amount NUMERIC(20, 4) NOT NULL,
    scheduled_date DATE NOT NULL, due_date_adjusted DATE NOT NULL, status VARCHAR(16) NOT NULL DEFAULT 'PENDING',
    pay_token VARCHAR(64) NOT NULL, pg_trn_id VARCHAR(32), paid_at TIMESTAMP, fee_pct_amount NUMERIC(12, 4),
    fee_fixed_amount NUMERIC(12, 4), mail_d_minus1_sent TIMESTAMP, mail_d0_sent TIMESTAMP, mail_d1_sent TIMESTAMP, mail_d2_sent TIMESTAMP,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- V187: JPAY UNPAID 오승인 정정 (승인번호 365675016778, 2026-06-25) — 이미 반영됐으면 0건
UPDATE pg_trnsctn
SET status = '20',
    paid_at = NULL,
