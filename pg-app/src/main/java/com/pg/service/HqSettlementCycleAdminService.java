...
public class HqSettlementCycleAdminService {
    ...
    private static final List<BuiltInRow> BUILT_INS = List.of(
            ...
            new BuiltInRow("W3", "W+3", "월~일 집계, 일요일 마감 후 3영업일째·마감시각 이후 자동 1회.", 30, true),
            new BuiltInRow("W5", "W+5", "월~일 집계, 일요일 마감 후 5영업일째·마감시각 이후 자동 1회.", 31, true),
            new BuiltInRow("W7", "W+7", "월~일 집계, 일요일 마감 후 7영업일째·마감시각 이후 자동 1회(공휴 시 익영업일).", 32, true),
            new BuiltInRow("W10", "W+10", "월~일 집계, 일요일 마감 후 10영업일째·마감시각 이후 자동 1회.", 33, true),
            new BuiltInRow("W14", "W+14", "월~일 집계, 일요일 마감 후 14영업일째·마감시각 이후 자동 1회.", 34, true),
