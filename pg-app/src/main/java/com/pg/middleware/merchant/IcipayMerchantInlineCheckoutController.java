...
import com.pg.merchantdeploy.MerchantInlineCheckoutService;
...
/**
 * 가맹점용 ChillPay 인라인 결제 API — ICOPAY {@code pay.html}(CCD·다중결제) 페이지를 호출·삽입하기 위한 세션 준비.
 */
@RestController
@RequestMapping("/api/middleware/v1/merchant/chillpay/inline-checkout")
public class IcipayMerchantInlineCheckoutController {
    ...
    public IcipayMerchantInlineCheckoutController(MerchantInlineCheckoutService inlineCheckoutService,
