...
public class SecurityConfig {
    ...
    public SecurityFilterChain embeddablePublicContentChain(HttpSecurity http) throws Exception {
        http.securityMatcher(new OrRequestMatcher(
                ...
                AntPathRequestMatcher.antMatcher("/ilk-pay"),
                AntPathRequestMatcher.antMatcher("/ilk-pay/**"),
                AntPathRequestMatcher.antMatcher("/ilk-pay.html"),
    ...
    public SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(AntPathRequestMatcher.antMatcher("/api/pay/ilk/**")).permitAll()
