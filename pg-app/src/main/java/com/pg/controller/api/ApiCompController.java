...
public class ApiCompController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> register(
            ...
            @RequestParam(required = false) String payFollowManualVoidYn,
            @RequestParam(required = false) String payFollowManualRefundYn,
            @RequestParam(required = false) String urlPayAlertEmailYn,
            @RequestParam(required = false) String urlPayLineNotifyToken,
            @RequestParam(required = false) String receiptEmailFollowHqYn,
            @RequestParam(required = false) String receiptEmailUseYn,
            @RequestParam(required = false) String receiptEmailEnabledYn,
        ...
        return ResponseEntity.ok(ApiResponse.ok(Map.of("compId", saved.getCode(), "compNm", saved.getName())));
            ...
            return ResponseEntity.ok(ApiResponse.fail(CompDataIntegrityMessages.forException(e), "DATA_INTEGRITY"));
        }
    }
        ...
        try {
            boolean ok = compService.update(compId, compNm, compDiv, parentId, compTel, zipCode, addr, addrDetail, addrEtc, addrCountryCd,
                ...
                payFollowManualVoidYn, payFollowManualRefundYn,
                    urlPayAlertEmailYn, urlPayLineNotifyToken,
                    receiptEmailFollowHqYn, receiptEmailUseYn, receiptEmailEnabledYn,
                    chatbotHeaderLogoUrl, chatbotAdminUsername,
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> pgBindingSave(@RequestBody Map<String, Object> body) {
        try {
            ...
            String currencyScope = body.get("currencyScope") != null ? body.get("currencyScope").toString() : "";
