...
(function (w) {
  ...
  var URL_TR = {
    '/hq/pgApiMng': T('PG integration', 'PG連携', '支付机构联动', 'เชื่อมต่อ PG'),
    '/hq/defaultCommission': T('Commission', '手数料', '手续费', 'ค่าธรรมเนียม'),
    '/hq/pgAgencyCostPolicy': T('Agency fee', '代行手数料', '代理手续费', 'ค่าธรรมเนียมตัวแทน'),
    '/hq/chargebackPolicy': T('Chargeback', 'チャージバック', '拒付/退单', 'Chargeback'),
    '/hq/riskCardPolicy': T('Risk', 'リスク', '风险', 'ความเสี่ยง'),
    '/hq/businessDaySetting': T('Business days', '営業日', '营业日', 'วันทำการ'),
    '/hq/apiConfig': T('Common settings', '共通設定', '通用设置', 'ตั้งค่าทั่วไป'),
    '/hq/apiMerchantDeployReg': T('Register merchant', '加盟店登録', '注册商户', 'ลงทะเบียนร้าน'),
    '/hq/merchantApiGenerate': T('Keys & docs', 'キー・文書', '密钥与文档', 'คีย์และเอกสาร'),
    '/hq/merchantApiDeployDocs': T('API docs', 'API文書', 'API 文档', 'เอกสาร API'),
    '/hq/merchantApiDeployKit': T('Keys & docs', 'キー・文書', '密钥与文档', 'คีย์และเอกสาร'),
    '/deploy/launchGuide': T('Launch guide', '公開ガイド', '发布指南', 'คู่มือเปิดใช้'),
    '/hq/urlPayDeploy': T('URL payment', 'URL決済', 'URL 支付', 'ชำระเงิน URL'),
    '/hq/paymentOrchestration': T('Payment routing', '決済ルーティング', '支付路由', 'เส้นทางชำระเงิน'),
    ...
    '/hq/domainConfig': T('Domain & SSL', 'ドメイン・SSL', '域名与 SSL', 'โดเมนและ SSL'),
    '/hq/serverManage': T('Server', 'サーバー', '服务器', 'เซิร์ฟเวอร์'),
    '/hq/chatbotAiSettings': T('AI & chatbot', 'AI・チャットボット', 'AI 与聊天机器人', 'AI และแชทบอท'),
    ...
    '/hq/permissionMng': T('HQ permissions', '本社権限', '总部权限', 'สิทธิ์ HQ'),
    '/hq/opsModeMng': T('Tablet UX', 'タブレットUX', '平板 UX', 'UX แท็บเล็ต'),
    '/hq/userSettings': T('Users', 'ユーザー', '用户', 'ผู้ใช้'),
    ...
    '/hq/orgViewColumnAllowance': T('Org columns', '組織項目', '组织字段', 'คอลัมน์องค์กร'),
    '/hq/accountMng': T('Merchant access', '加盟店アクセス', '商户访问', 'การเข้าถึงร้าน'),
    ...
    '/set/gridSetMng': T('Column order', '項目順', '字段顺序', 'ลำดับคอลัมน์'),
    ...
    '/deploy/merchantApiPolicy': T('API deploy policy', 'API配布ポリシー', 'API 发布政策', 'นโยบายเผยแพร่ API'),
    ...
    '/ops/opsManuals': T('Ops manuals', '運営マニュアル', '运营手册', 'คู่มือปฏิบัติการ'),
    '/hq/platformOpsManuals': T('Ops manuals', '運営マニュアル', '运营手册', 'คู่มือปฏิบัติการ'),
