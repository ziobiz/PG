...
(function (global) {
   ...
   */
  var CHATBOT_PROD_MIN_PX = { 4: 88, 5: 152, 6: 136, 7: 120, 8: 260, 9: 80, 11: 44, 12: 72, 13: 72, 14: 104, 15: 100 };
  /** 좁게 유지할 열(순서·# 등) 상한 + 통화·이미지 등 과확대 방지. 설명(8)·상품명(5)은 상한 없음 → 남는 폭 흡수. 6·7은 짧은 한줄 라벨이 세로로 쌓이지 않도록 상한을 넉넉히 둠 */
