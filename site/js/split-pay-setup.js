(function () {
  ...
  var I18N = {
    ...
    KOR: { brand: 'ICOPAY', subtitle: '분할결제 신청', email: '이메일', name: '이름', totalAmount: '총금액', count: '회차 수', payTerm: '결제 기간', interval: '나누기 방식', month: '월 단위', day: 'N일 단위', multi: '멀티(고객 선택)', intervalDays: '일 간격', intervalMonths: '월 간격', preview: '일정 미리보기', create: '계약 생성', created: '계약이 생성되었습니다.', firstPay: '1회차 결제', err: '처리할 수 없습니다.', disabled: '이 가맹점은 분할결제를 사용하지 않습니다.', checkoutSubtitlePrevent: '결제 오류를 방지하기 위해 정확한 카드 정보를 입력해 주세요.', checkoutSubtitleConfirm: '카드번호, 유효기간, CVC 번호가 올바른지 다시 한번 확인해 주세요.', checkoutSubtitleApproval: '원활한 결제 처리를 위해 카드 정보를 오타 없이 입력해 주시기 바랍니다.', checkoutSubtitleFail: '카드 정보가 일치하지 않을 경우 결제 승인이 거절될 수 있습니다.' },

    ENG: { brand: 'ICOPAY', subtitle: 'Split payment setup', email: 'Email', name: 'Name', totalAmount: 'Total amount', count: 'Installments', payTerm: 'Pay term', interval: 'Interval', month: 'Monthly', day: 'Every N days', multi: 'Multi (customer choice)', intervalDays: 'Day interval', intervalMonths: 'Month interval', preview: 'Preview schedule', create: 'Create contract', created: 'Contract created.', firstPay: 'Pay first installment', err: 'Request failed.', disabled: 'Split pay is not enabled for this merchant.', checkoutSubtitlePrevent: 'To help prevent payment errors, please enter accurate card details.', checkoutSubtitleConfirm: 'Please double-check that your card number, expiry date, and CVC are correct.', checkoutSubtitleApproval: 'For smooth processing, please enter your card details without typos.', checkoutSubtitleFail: 'Payment may be declined if the card details do not match.' },

    JPN: { brand: 'ICOPAY', subtitle: '分割払い申込', email: 'メール', name: '氏名', totalAmount: '総額', count: '回数', payTerm: '支払期間', interval: '分割方式', month: '月単位', day: 'N日単位', multi: 'マルチ(お客様選択)', intervalDays: '日間隔', intervalMonths: '月間隔', preview: 'スケジュール確認', create: '契約作成', created: '契約を作成しました。', firstPay: '初回支払い', err: '処理できません。', disabled: '分割払いは利用できません。', checkoutSubtitlePrevent: '決済エラーを防ぐため、正確なカード情報を入力してください。', checkoutSubtitleConfirm: 'カード番号・有効期限・CVC番号が正しいか再度ご確認ください。', checkoutSubtitleApproval: 'スムーズな決済のため、カード情報を誤字なく入力してください。', checkoutSubtitleFail: 'カード情報が一致しない場合、決済が拒否されることがあります。' },

    CHN: { brand: 'ICOPAY', subtitle: '分期付款申请', email: '邮箱', name: '姓名', totalAmount: '总金额', count: '期数', payTerm: '付款期限', interval: '分期方式', month: '按月', day: '按N天', multi: '多选(客户自选)', intervalDays: '天数间隔', intervalMonths: '月数间隔', preview: '预览计划', create: '创建合同', created: '合同已创建。', firstPay: '支付首期', err: '无法处理。', disabled: '该商户未启用分期付款。', checkoutSubtitlePrevent: '为避免支付错误，请准确填写银行卡信息。', checkoutSubtitleConfirm: '请再次确认卡号、有效期和 CVC 是否正确。', checkoutSubtitleApproval: '为顺利完成支付，请无误填写卡信息。', checkoutSubtitleFail: '若卡信息不一致，支付可能被拒绝。' },

    THA: { brand: 'ICOPAY', subtitle: 'ตั้งค่าแบ่งงวด', email: 'อีเมล', name: 'ชื่อ', totalAmount: 'ยอดรวม', count: 'จำนวนงวด', payTerm: 'ระยะชำระ', interval: 'รอบ', month: 'รายเดือน', day: 'ทุก N วัน', multi: 'มัลติ(ลูกค้าเลือก)', intervalDays: 'ช่วงวัน', intervalMonths: 'ช่วงเดือน', preview: 'ดูตาราง', create: 'สร้างสัญญา', created: 'สร้างสัญญาแล้ว', firstPay: 'ชำระงวดแรก', err: 'ดำเนินการไม่ได้', disabled: 'ร้านนี้ไม่เปิดแบ่งงวด', checkoutSubtitlePrevent: 'เพื่อป้องกันข้อผิดพลาดในการชำระ กรุณากรอกข้อมูลบัตรให้ถูกต้อง', checkoutSubtitleConfirm: 'กรุณาตรวจสอบหมายเลขบัตร วันหมดอายุ และ CVC อีกครั้ง', checkoutSubtitleApproval: 'เพื่อการชำระที่ราบรื่น กรุณากรอกข้อมูลบัตรโดยไม่มีตัวสะกดผิด', checkoutSubtitleFail: 'หากข้อมูลบัตรไม่ตรงกัน การอนุมัติอาจถูกปฏิเสธ' }
