(function () {
  ...
  var checkoutCtx = {};
  var I18N = {
    KOR: { brand: 'ICOPAY', subtitle: '분할결제', contractNo: '계약번호', orderNo: '주문번호', totalAmount: '총금액', installments: '총 회차', current: '이번 회차·금액', remaining: '남은 회차', next: '다음 금액·일자', goPay: '결제 진행', loadErr: '결제 정보를 불러올 수 없습니다.', paid: '이미 결제된 회차입니다.', checkoutSubtitlePrevent: '결제 오류를 방지하기 위해 정확한 카드 정보를 입력해 주세요.', checkoutSubtitleConfirm: '카드번호, 유효기간, CVC 번호가 올바른지 다시 한번 확인해 주세요.', checkoutSubtitleApproval: '원활한 결제 처리를 위해 카드 정보를 오타 없이 입력해 주시기 바랍니다.', checkoutSubtitleFail: '카드 정보가 일치하지 않을 경우 결제 승인이 거절될 수 있습니다.' },
    ENG: { brand: 'ICOPAY', subtitle: 'Split payment', contractNo: 'Contract', orderNo: 'Order No', totalAmount: 'Total', installments: 'Installments', current: 'This installment', remaining: 'Remaining', next: 'Next amount · date', goPay: 'Proceed to payment', loadErr: 'Cannot load payment info.', paid: 'Already paid.', checkoutSubtitlePrevent: 'To help prevent payment errors, please enter accurate card details.', checkoutSubtitleConfirm: 'Please double-check that your card number, expiry date, and CVC are correct.', checkoutSubtitleApproval: 'For smooth processing, please enter your card details without typos.', checkoutSubtitleFail: 'Payment may be declined if the card details do not match.' },
    JPN: { brand: 'ICOPAY', subtitle: '分割払い', contractNo: '契約番号', orderNo: '注文番号', totalAmount: '総額', installments: '総回数', current: '今回の支払い', remaining: '残り回数', next: '次回金額・日付', goPay: '支払いへ', loadErr: '情報を読み込めません。', paid: '支払い済みです。', checkoutSubtitlePrevent: '決済エラーを防ぐため、正確なカード情報を入力してください。', checkoutSubtitleConfirm: 'カード番号・有効期限・CVC番号が正しいか再度ご確認ください。', checkoutSubtitleApproval: 'スムーズな決済のため、カード情報を誤字なく入力してください。', checkoutSubtitleFail: 'カード情報が一致しない場合、決済が拒否されることがあります。' },
    CHN: { brand: 'ICOPAY', subtitle: '分期付款', contractNo: '合同号', orderNo: '订单号', totalAmount: '总金额', installments: '总期数', current: '本期付款', remaining: '剩余期数', next: '下期金额·日期', goPay: '前往付款', loadErr: '无法加载付款信息。', paid: '已付款。', checkoutSubtitlePrevent: '为避免支付错误，请准确填写银行卡信息。', checkoutSubtitleConfirm: '请再次确认卡号、有效期和 CVC 是否正确。', checkoutSubtitleApproval: '为顺利完成支付，请无误填写卡信息。', checkoutSubtitleFail: '若卡信息不一致，支付可能被拒绝。' },
    THA: { brand: 'ICOPAY', subtitle: 'ชำระแบบแบ่งงวด', contractNo: 'เลขสัญญา', orderNo: 'เลขคำสั่ง', totalAmount: 'ยอดรวม', installments: 'จำนวนงวด', current: 'งวดนี้', remaining: 'งวดคงเหลือ', next: 'งวดถัดไป', goPay: 'ดำเนินการชำระ', loadErr: 'โหลดข้อมูลไม่ได้', paid: 'ชำระแล้ว', checkoutSubtitlePrevent: 'เพื่อป้องกันข้อผิดพลาดในการชำระ กรุณากรอกข้อมูลบัตรให้ถูกต้อง', checkoutSubtitleConfirm: 'กรุณาตรวจสอบหมายเลขบัตร วันหมดอายุ และ CVC อีกครั้ง', checkoutSubtitleApproval: 'เพื่อการชำระที่ราบรื่น กรุณากรอกข้อมูลบัตรโดยไม่มีตัวสะกดผิด', checkoutSubtitleFail: 'หากข้อมูลบัตรไม่ตรงกัน การอนุมัติอาจถูกปฏิเสธ' }
  };
